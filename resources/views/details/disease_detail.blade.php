...
<section class="news detail">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-sm-12 px-2">
                <h2 class="text-primary">{!! $disease['name'] !!}</h2>
                    <div class="more_info pt-1 pb-3 pl-2">
                        <p class="text-primary text-truncate">{!!$disease['title']!!}</p>
            ...
            <div class="col-sm-12 py-2">
                <h5 class="px-2 text-uppercase">Symptom</h5>
                <p>{!! $disease['symptom'] !!}</p>
            </div>
            <div class="col-sm-12 py-2">
                <h5 class="px-2 text-uppercase">Treatment</h5>
                <p>{!! $disease['treatment'] !!}</p>
            </div>
            <div class="col-sm-12 py-2">
                <h5 class="text-uppercase px-2">diagnosis</h5>
