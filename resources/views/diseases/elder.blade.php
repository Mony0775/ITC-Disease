...
<nav aria-label="breadcrumb"
  <ol class="breadcrumb container">
    ...
    <li class="breadcrumb-item active" aria-current="page">Elder</li>
  </ol>
</nav>
<section class="container bg-white-50 gradient-custom">
<div class="title">
    <h4 class="text-center py-3 text-uppercase text-primary"><strong>Common Disease for Elder: </strong></h4>
